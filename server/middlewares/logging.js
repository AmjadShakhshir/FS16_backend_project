...
var monitorRequest = function (req, res, next, isReturn) {
    ...
    if (true) {
        res.on("finish", function () {
            ...
            for (var _i = 0, _a = Object.entries(exports.statusCodes); _i < _a.length; _i++) {
                var _b = _a[_i], key = _b[0], value = _b[1];
                value > 0 && console.log("Code: ".concat(key, ": requests: ").concat(value));
            }
        });
    }
    if (isReturn) {
